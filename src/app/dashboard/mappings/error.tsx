...
export default function MappingsError({ error, reset }: MappingsErrorProps) {
  return (
    <PageContainer>
      <section className="rounded-3xl border border-red-300/20 bg-red-400/10 p-8 text-center">
        ...
        <h1 className="mt-5 text-2xl font-semibold text-white">Não foi possível carregar mapeamentos</h1>

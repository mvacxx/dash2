...
const highlights = [
  {
    icon: Users,
    title: "Multiusuário",
    description: "Base preparada para autenticação e acesso protegido por usuário.",
  },
  {
    icon: BarChart3,
    title: "Pronto para dashboards",
    description: "Estrutura inicial organizada para evoluir relatórios no momento certo.",
  },
  {
    icon: LockKeyhole,
  ...
  return (
    <main className="mx-auto flex min-h-screen w-full max-w-6xl flex-col px-6 py-10">
      <nav className="flex items-center justify-between">
        <span className="text-lg font-semibold tracking-tight">Dashzada ROI</span>
        <Link
          href="/dashboard"
      ...
      <section className="grid flex-1 items-center gap-12 py-20 lg:grid-cols-[1.1fr_0.9fr]">
        <div>
          ...
          <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-300">
            O Dashzada ROI nasce como uma fundação segura, tipada e organizada para
            evoluir a comparação entre gastos de mídia e receitas em etapas futuras.
          </p>
          ...
          <div className="rounded-2xl border border-white/10 bg-slate-950/70 p-5">
            <div className="mb-6 flex items-center justify-between">
              <div>
                ...
                <h2 className="text-2xl font-semibold text-white">Fundação pronta</h2>
              </div>
